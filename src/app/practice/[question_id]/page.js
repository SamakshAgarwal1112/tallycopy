...
export default function QuestionPage() {
    ...
    return (
        <Flex>
            <Flex direction={'column'} height={'100vh'} paddingInline={'4rem'} paddingBlock={'2rem'} border={'1px solid black'} borderRadius={'5px'} color={'white'} bgColor={'#222222'} width={'50vw'}>
                <Flex align={'center'}>
                ...
                <Text>
                    <Badge colorScheme={'green'} variant={'subtle'} fontSize={'xs'} borderRadius={'10px'} paddingInline={'5px'}>{question.difficulty || 'Easy'}</Badge>
                </Text>
                ...
                </Box>
                {
                    testcases.map((testcase, index) => (
                        index<3 && <Box key={index} padding={'1rem'} bgColor={'#323232'} borderRadius={'5px'} marginBottom={'1rem'}>
            ...
            <Stack spacing={4} height={'100vh'} justify={'center'} align={'center'} paddingInline={'4rem'} paddingBlock={'2rem'} border={'1px solid black'} borderRadius={'5px'} color={'white'} bgColor={'#222222'} width={'50vw'}>
                <CodeEditor/>
                <TestCaseTabs/>
            </Stack>
        </Flex>
